module.exports = {
    ...
    home: {
        header: {
			...
			emmen: {
                title: "Emmen. participatiewebshop",
                subtitle: "Welkom op de participatiewebshop van de gemeente Emmen.",
                auth_subtitle: "Welkom op de participatiewebshopvan de gemeente Emmen. <br /><br />Beheer uw vouchers en neem ze overal mee door de Me-app te downloaden.",
                auth_button: "Download Me",
                button: 'START MET ACTIVEREN',
            },
            westerkwartier: {
        ...
        blog: {
			...
			emmen: {
                title: "Onze blog",
                name: "Blog: Nieuw fonds participatieregeling 2019 Emmen",
            },
            westerkwartier: {
                title: "Onze blog",
